    ...
    return (
        <>
                    ...
                    <div className="grid lg:grid-cols-12 gap-16 items-center">
                        ...
                        <div className="lg:col-span-7 space-y-12 reveal">
                            <h1 className="text-6xl md:text-8xl font-bold tracking-tighter leading-[0.85] text-white">
                                About <br /> <span className="text-yellow-400 italic">Deexon Solutions</span>
                            </h1>
                        ...
                        <div className="lg:col-span-5 reveal relative group">
                            <div className="absolute -inset-4 bg-yellow-400/10 blur-3xl rounded-full opacity-50 group-hover:opacity-100 transition-all duration-1000"></div>
            ...
            <section
                ...
                className="relative py-30 border-b border-white/5 bg-[#0A0A0F]">
                <div className="max-w-7xl mx-auto px-6 max-[400px]:px-3">
                    <div className="grid lg:grid-cols-2 gap-px bg-white/10 border border-white/10 overflow-hidden">
                        <div className="bg-[#08080A] p-20 max-[400px]:p-10 reveal hover:bg-white/[0.02] transition-colors">
                            <h2 className="text-4xl text-white text-center font-bold mb-8 tracking-tight">Our Mission</h2>
                            <p className="text-white text-center text-xl font leading-relaxed">
                        ...
                        <div className=" text-center p-20 max-[400px]:p-10 reveal hover:bg-white/[0.02] transition-colors">
            ...
            {/* Core Values */}
            <section className="relative py-30 bg-[#08080A] border-b border-white/5">
                <div className="max-w-7xl mx-auto px-6">
                    <h2 className="text-5xl md:text-7xl font-bold tracking-tighter text-white mb-24 reveal">
                        Our Core <span className="text-yellow-400">Values</span>
                    </h2>

                    <div className="grid md:grid-cols-2 gap-px bg-white/5 border border-white/5">
                        {coreValues.map((v) => (
                            <div key={v.title} className="bg-[#08080A] p-12 group hover:bg-white/[0.02] transition-all duration-500 reveal">
                                <h3 className="text-2xl font-bold text-white mb-6 tracking-tight">{v.title}</h3>
                                <p className="text-white text-base leading-relaxed font">{v.desc}</p>
                                <div className="mt-8 h-px w-0 bg-yellow-400 group-hover:w-full transition-all duration-700"></div>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            {/* Brand Ambassador */}
            <section className="relative py-30 border-b border-white/10 bg-[#0A0A0F]">
                <div className="max-w-7xl mx-auto px-6">
                    <h2 className="text-4xl text-white md:text-6xl font-bold text-center mb-24 reveal">
                        Our <span className="text-yellow-400">Brand </span> Ambassador
                    </h2>

                    <div className="grid lg:grid-cols-12 gap-20 items-start">
                        <div className="lg:col-span-5 reveal group">
                            <div className="relative p-1 bg-gradient-to-br from-yellow-400/20 to-transparent rounded-3xl">
                                <img
                                    src={ambassador}
                            ...
                            <p className="mt-8 text-white font-bold text-xl tracking-tight">Miss Tiffany Grant</p>
                            <p className="text-yellow-400 text-xs font-mono tracking-widest uppercase mt-1">Brand Ambassador</p>
                        </div>

                        <div className="lg:col-span-7 space-y-8 text-white text-lg font leading-relaxed reveal">
                            <p><strong className="text-white">Miss Tiffany Grant</strong><br />Brand Ambassador, DEEXON SOLUTIONS.</p>
                            ...
                            <ul className="space-y-4 border-l-4 border-yellow-400 pl-8 py-2">
                                <li className="flex gap-4 items-start"><div className="h-1 w-2 bg-yellow-400 mt-3"></div> <span>Promoting awareness of our ICT and digital services on a global scale.</span></li>
                                <li className="flex gap-4 items-start"><div className="h-1 w-2 bg-yellow-400 mt-3"></div> <span>Inspiring young people to explore and master modern technology.</span></li>
                                <li className="flex gap-4 items-start"><div className="h-1 w-2 bg-yellow-400 mt-3"></div> <span>Strengthening our brand connection through community engagement, global outreach, and creative collaborations.</span></li>
                            </ul>
                            ...
                            <p className="text-yellow-400 text-2xl italic font pt-8 border-t border-white/5">
            ...
            {/* Founder & CEO */}
            <section className="relative py-30 bg-[#08080A]">
                <div className="max-w-7xl mx-auto px-6">
                    <h2 className="text-4xl text-white md:text-6xl font-bold text-center mb-24 reveal">
                    ...
                    <div className="grid lg:grid-cols-12 gap-20 items-start">
                        <div className="lg:col-span-7 space-y-8 text-white text-lg font leading-relaxed reveal order-2 lg:order-1">
                            <p><strong className="text-white">David Inyang</strong><br />Founder & CEO DEEXON SOLUTIONS</p>
                            ...
                            <p className="text-white font-bold tracking-widest text-xs uppercase pt-8">A Vision Rooted in Innovation</p>
                            ...
                            <p className="text-white font-bold tracking-widest text-xs uppercase pt-8">Under his leadership, the company has evolved into a multi-service organization providing:</p>
                            <ul className="space-y-4 border-l-4 border-yellow-400 pl-8 py-2">
                                <li className="flex gap-4 items-start"><div className="h-1 w-2 bg-yellow-400 mt-3"></div> <span>Website Design & Development that helps businesses establish powerful online presences.</span></li>
                                <li className="flex gap-4 items-start"><div className="h-1 w-2 bg-yellow-400 mt-3"></div> <span>ICT Training Programs that equip individuals with essential digital skills for the modern world.</span></li>
                                <li className="flex gap-4 items-start"><div className="h-1 w-2 bg-yellow-400 mt-3"></div> <span>E-commerce Solutions that enable brands to reach global audiences.</span></li>
                                <li className="flex gap-4 items-start"><div className="h-1 w-2 bg-yellow-400 mt-3"></div> <span>Offline Learning Platforms that make digital education accessible to everyone.</span></li>
                            </ul>

                            <p className="text-white font-bold tracking-widest text-xs uppercase pt-8">Leadership Philosophy</p>
                            ...
                            <p className="text-white font-bold tracking-widest text-xs uppercase pt-8">Commitment to the Future</p>
                        ...
                        <div className="lg:col-span-5 reveal top-32 order-1 lg:order-2">
                            ...
                            <p className="mt-8 text-white font-bold text-xl tracking-tight text-right">David Inyang</p>
                            <p className="text-yellow-400 text-xs font-mono tracking-widest uppercase mt-1 text-right">Founder & CEO</p>
                        </div>
